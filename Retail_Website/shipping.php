...
<body>
		...
		<nav class="navbar navbar-expand-md navbar-dark bg-dark">
			...
			<div class="collapse navbar-collapse" id="rightMainNavBar">
				<ul class= "navbar-nav mr-auto">
				    ...
				    <form action="shipping.php" method="post" class="col" id="searchBarForm">
						<li>
	...
	<?php
		if(isset($_POST['shippingContinueBtn']))
		{
			...
			$zip = $_POST['zip'];
					...
					$query = "INSERT into Shipping_address values ('$userid', '$name', '$phone', '$address' , '$city', '$state', '$zip')";
					$query_run = mysqli_query($conn,$query);
					
					//everyting went smoothly...entering shipping info in database!
					if($query_run)
					{
					...
					{
						echo ('<script type="text/javascript">alert("Shipping Info Did Not Send!")</script>');	
					}
		}
	?>
    <!-- SHIPPING PAGE -->  
    <div class="container">
        ...
        <form id="shippingForm" action="#" method="POST">
            <div class="row">
                <div class="col-6">
                    <input class="shippingFormInput" type="text" placeholder="Full Name" id="name" name="name" required="required">
                </div>
                <div class="col-6">
                    <input class="shippingFormInput" type="tel" placeholder="Phone" id="phone" name="phone" 
					pattern="[0-9]{3}[0-9]{3}[0-9]{4}" required="required">
                </div>
            </div>
            <div class="row">
				<div class="col-6">
                    <input class="shippingFormInput"  type="text" placeholder="Address" id="address" name="address"  required="required">
                </div>
                <div class="col-6">
                    <input class="shippingFormInput" type="text" placeholder="City" id="city"  name="city" required="required">
                </div>
            </div>
            <div class="row">
				<div class="col-6">
                    <select class="shippingFormInput"  type="tel" id="state" name="state"  required="required">
                ...
                <div class="col-6">
                    <input class="shippingFormInput"  type="text" placeholder="Zip Code" id="zip" name="zip" required="required">
                </div>
            </div>
			<div class="row d-flex justify-content-center">
            	<input type="submit" name="shippingContinueBtn" id="continueBtn" value="CONTINUE"/>
			</div>
			<div class="row d-flex justify-content-center">
				<input type="button" id="shippingBackBtn" onClick="window.location='shoppingCart.php'" value="BACK"/>
			</div>
        </form>
    </div>
</body>
